...
Route::get('/', function () { 
    $versao = App\Models\Versao::all();   
    $user = Auth::id();
    $arquivos = App\Models\File::where('user_id','=',$user)->get();
    return view('dashboard.homepage',compact('arquivos','versao')); })->middleware('auth')->name('home');
    Route::get('/download/{file}', 'UploadController@download');
    Route::get('/arquivos', 'UploadController@index')->name('index');
    Route::get('/storage/public/{filename}', 'UploadController@getFile')->name('getfile');
    Route::post('/uploadFile', 'UploadController@uploadFile')->name('uploadFile');
    Route::get('/Versoes', 'VersoesController@index')->name('Versoes');
    Route::POST('/Versoes/salvar','VersoesController@salvar')->name('versoes.salvar');
    Route::get('/uploadFile/deletar/{id}','UploadController@deletar')->name('arquivo.deletar');
    Route::get('/Versoes/deletar/{id}','VersoesController@deletar')->name('versoes.deletar');
